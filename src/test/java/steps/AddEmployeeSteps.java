...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_enters_and(String firstName, String middleName, String lastName) {
        ...
        firstNmeFE=firstName;
        middleNmeFE=middleName;
        lastNmeFE=lastName;
    ...
    public void fetchTheInformationFromBackend() {
       ...
       Map<String,String> rowData=data.get(0);
        ...
        String lastNameNameDB=rowData.get("emp_lastname");
        Assert.assertEquals(firstNmeFE,firstNameDB);
        Assert.assertEquals(middleNmeFE,middleNameDB);
        Assert.assertEquals(lastNmeFE,lastNameNameDB);
